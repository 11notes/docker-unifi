...
* [10.1.85](https://hub.docker.com/r/11notes/unifi/tags?name=10.1.85)
* [10.1.85-unraid](https://hub.docker.com/r/11notes/unifi/tags?name=10.1.85-unraid)
* [10.1.85-nobody](https://hub.docker.com/r/11notes/unifi/tags?name=10.1.85-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/unifi:10.1.85
docker pull ghcr.io/11notes/unifi:10.1.85
docker pull quay.io/11notes/unifi:10.1.85
```
...
*created 10.04.2026, 00:46:05 (CET)*