...
* [10.1.89](https://hub.docker.com/r/11notes/unifi/tags?name=10.1.89)
* [10.1.89-unraid](https://hub.docker.com/r/11notes/unifi/tags?name=10.1.89-unraid)
* [10.1.89-nobody](https://hub.docker.com/r/11notes/unifi/tags?name=10.1.89-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/unifi:10.1.89
docker pull ghcr.io/11notes/unifi:10.1.89
docker pull quay.io/11notes/unifi:10.1.89
```
...
*created 19.03.2026, 06:57:30 (CET)*